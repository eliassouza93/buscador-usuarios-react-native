            ...
            <View style={estilos.container}>
                <>
                    ...
                    <View style={estilos.imagemArea}>
                        <Image source={{ uri: 'http://github.com/eliassouza93.png' }} style={estilos.imagem} />
                    </View>
                    <Text style={estilos.textoNome}>Nome do usuario</Text>
                    <Text style={estilos.textoEmail}>Email do usuario</Text>
                    <View style={estilos.seguidoresArea}>
                        <View style={estilos.seguidores}>
                            <Text style={estilos.seguidoresNumero}>3</Text>
                            <Text style={estilos.seguidoresTexto}>Seguidores</Text>
                        </View>
                        <View style={estilos.seguidores}>
                            <Text style={estilos.seguidoresNumero}>5</Text>
